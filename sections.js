...
function Booking({ lang, data, i18n }) {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "section", id: "booking" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement(SectionHead, { num: s.num, title: pick(s.title, lang), kicker: pick(s.kicker, lang) }), /* @__PURE__ */ React.createElement(Reveal, null, /* @__PURE__ */ React.createElement("div", { className: "contact-block" }, /* @__PURE__ */ React.createElement("div", { className: "contact-row" }, /* @__PURE__ */ React.createElement("div", { className: "contact-label" }, pick(data.contact.booking.label, lang)), /* @__PURE__ */ React.createElement("div", { className: "contact-value" }, /* @__PURE__ */ React.createElement("a", { href: `mailto:${data.contact.booking.email}` }, data.contact.booking.email))), /* @__PURE__ */ React.createElement("div", { className: "contact-row" }, /* @__PURE__ */ React.createElement("div", { className: "contact-label" }, pick(data.contact.press.label, lang)), /* @__PURE__ */ React.createElement("div", { className: "contact-value" }, /* @__PURE__ */ React.createElement("a", { href: `mailto:${data.contact.press.email}` }, data.contact.press.email))), /* @__PURE__ */ React.createElement("div", { className: "contact-row" }, /* @__PURE__ */ React.createElement("div", { className: "contact-label" }, pick(data.contact.epk.label, lang)), /* @__PURE__ */ React.createElement("div", { className: "contact-value" }, /* @__PURE__ */ React.createElement("a", { href: data.contact.epk.url, target: "_blank", rel: "noreferrer" }, pick(data.contact.epk.display, lang)))), /* @__PURE__ */ React.createElement("div", { className: "contact-row" }, /* @__PURE__ */ React.createElement("div", { className: "contact-label" }, pick(data.contact.store.label, lang)), /* @__PURE__ */ React.createElement("div", { className: "contact-value" }, /* @__PURE__ */ React.createElement("a", { href: data.contact.store.url, target: "_blank", rel: "noreferrer" }, data.contact.store.display)))))));
}
